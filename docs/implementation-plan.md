...
- backend redaction-boundary tests covering destination sensitive config
  storage separation and canary checks across plan, association, queue, drain,
  status, and reconcile responses.
